...
const challengeDatas: { [key: number]: ChallengeData } = {
  ...
  1074:  { title: 'Z', level: 'Silver I', tags: ['Divide and conquer'] },
  ...
  4422:  { title: 'Crypt Kicker II', level: 'Gold V', tags: ['Implementation'] },
  ...
  6549:  { title: '히스토그램에서 가장 큰 직사각형', level: 'Platinum V', tags: ['Stack'] },
  6588:  { title: '골드바흐의 추측', level: 'Silver I', tags: ['Mathematics'] },
  ...
  8979:  { title: '올림픽', level: 'Silver V', tags: ['Sorting'] },
  ...
  10610: { title: '30', level: 'Silver V', tags: ['Mathematics', 'Sorting'] },
